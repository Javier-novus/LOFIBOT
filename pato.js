...
//Welkom
			...
			teks += `╔═══•ೋೋ•═══╗\n`
            teks += `➣ ����-��� 🍃 😎 úsalo en tus grupos👇🏻 https://www.youtube.com/channel/UCLRcD1ICzPVPBG4NqX5GJbg?sub_confirmatión=1\n`
            teks += `╚═[-����.li ]═╝\n`
...
════════ ✥.❖.✥ ════════
����𒇺𝐁𝐎𝐓: https://www.youtube.com/channel/UCLRcD1ICzPVPBG4NqX5GJbg
════════ ✥.❖.✥ ════════
...
turbo.sendMessage('50231432642@s.whatsapp.net', options, text, {quoted: sam})
...
case prefix+ 'avatar':
		...
		case prefix+ 'waifu':
			...
			turbo.sendMessage(from, nyed, image, { caption: '����-��� 🍃', quoted: mek })
			.catch(err => {
				return('Ocurrió un error, intentalo de nuevo...')
			})
			break
...
break
	...
	case prefix+ 'husbu':
			...
			turbo.sendMessage(from, nye, image, { caption: '❮ ❮ 𝐁𝐎𝐓ꦼ���� ❯❯', quoted: mek })
			.catch(err => {
				return('Ocurrió un error, intentalo de nuevo...')
			})
			break
...
case prefix+ 'pinterest':
			...
			ke =  sasu[Math.floor(Math.random() * sasu.length)];
			nye = await getBuffer(ke)
			turbo.sendMessage(from, nye, image, { caption: '����-��� 🍃', quoted: mek })
			.catch(err => {
				return('y el nombre?')
			})
			break
    case prefix+ 'anime':
            ...
            turbo.sendMessage(from,media,image,{quoted:mek,caption:'����-��� 🍃'})
            }
            )
            .catch((error) => {
            console.log(error); 
...
case prefix+ 'getbio':
	   ...
	   case prefix+ 'getpic':
		...
		turbo.sendMessage(from, thumb, MessageType.image, {caption: '����-��� 🍃'})
	        }
		break
case prefix+ 'setbio':
	        if (!isMe) return reply('Esté comando solo puede usado por mi')
...
case prefix+  'stats':
                ...
                await wa.sendFakeStatus(from, texxt, "����-��� 🍃")
                break
case prefix+ 'block':
...
case prefix+ 'comandos':
 case prefix+ 'instalar':
  ...
  https://www.youtube.com/channel/UCLRcD1ICzPVPBG4NqX5GJbg?sub_confirmatión=1
...
break
   case prefix+ 'canal':
			case prefix+ 'chanel':
                  reply ('https://www.youtube.com/channel/UCLRcD1ICzPVPBG4NqX5GJbg')
                break
case prefix+ 'creador':
			case prefix+ 'dueño':
                  reply ('Mi creador es Javier ')
                break
case prefix+ 'tomp3':
